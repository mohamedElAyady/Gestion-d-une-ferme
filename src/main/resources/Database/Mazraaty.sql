...
CREATE TABLE admin (`prenom` VARCHAR(40) NOT NULL ,
`nom` VARCHAR(40) NOT NULL , `password` VARCHAR(60) NOT NULL ,
`email` VARCHAR(100) NOT NULL , `sexe` ENUM('homme','femme')
NOT NULL , `date` DATE NOT NULL , `adresse` TEXT NOT NULL ) ENGINE = InnoDB;